...
struct Project: CloudFirestoreItemDelegate {
    ...
    var langdescriptors: Array<String>
    ...
    var upvotes: Array<String>
    var downvotes: Array<String>
...
struct ProjectView: View {
    ...
    @State var projects: Array<Project> = Array<Project>()
    ...
    @State var selectedItem: Project? = nil
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            List {
                ...
                ForEach(self.projects, id: \.self.id) { project in
                    Group {
                        Button {
                        ...
                        .overlay(
                            ...
                            NavigationLink(
                                ...
                                destination: { if let item = self.selectedItem { /*ProjectContentsView(withIdea: item, hideTabBar: self.$linkToTheChosenController)*/ } },
                                label: { EmptyView() }
                            )
                            .isDetailLink(false)
                            .opacity(0)
            ...
            .task {
//                fsmanager.loadIdeas(sortBy: sortDescriptor, category: category, subDevCategory: subDevCategory, subAdminCategory: subAdminCategory, subDesignCategory: subDesignCategory, subTestCategory: subTestCategory, difficultLevel: difficultLevel, languages: languages, textStringQuery: self.searchText) { newProjects in
...
//                }
        ...
        .searchable(text: self.$searchText, placement: .navigationBarDrawer(displayMode: .always), prompt: LocalizedStringKey("Search for new projects..."))
