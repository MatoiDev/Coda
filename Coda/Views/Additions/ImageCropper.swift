...
//  Coda
//
//  Created by Matoi on 08.11.2022.
//
        ...
        ZStack{
            ...
            Group{
                ...
                //                .foregroundColor(Color.red.opacity(0.3))
                    ...
                    .frame(width: abs(((imageWidth-getDimension(w: imageWidth, h: imageHeight))/2) + activeOffset.width + (getDimension(w: imageWidth, h: imageHeight) * (1 - activeMagnification) / 2)), height: abs(imageHeight))
                ...
                //                .foregroundColor(Color.yellow.opacity(0.3))
                    .foregroundColor(surroundingColor)
                    .frame(width: abs(getDimension(w: imageWidth, h: imageHeight) * activeMagnification), height: abs(((imageHeight-getDimension(w: imageWidth, h: imageHeight))/2) + activeOffset.height + (getDimension(w: imageWidth, h: imageHeight) * (1 - activeMagnification) / 2)))
