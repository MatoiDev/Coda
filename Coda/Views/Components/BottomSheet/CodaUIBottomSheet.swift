...
public struct CodaUIBottomSheet<HContent: View, MContent: View, V: View>: View {
...
public extension View {
    ...
    ) -> CodaUIBottomSheet<HContent, MContent, Self> {
        CodaUIBottomSheet(
            bottomSheetPosition: bottomSheetPosition,
            switchablePositions: switchablePositions,
    ...
    ) -> CodaUIBottomSheet<TitleContent, MContent, Self> {
        CodaUIBottomSheet(
            bottomSheetPosition: bottomSheetPosition,
            switchablePositions: switchablePositions,
            title: title,
