...
public extension CodaUIBottomSheet {
    ...
    ) -> CodaUIBottomSheet where Background: View {
    ...
    ) -> CodaUIBottomSheet where V: View {
    ...
    ) -> CodaUIBottomSheet where S: ShapeStyle {
    ...
    ) -> CodaUIBottomSheet where S: ShapeStyle, T: Shape {
        self.configuration.backgroundView = AnyView(
            shape
                .fill(
                    style,
    ...
    func customBackground<S, T>(
        ...
        in shape: T,
        fillStyle: FillStyle = FillStyle()
    ) -> CodaUIBottomSheet where S: ShapeStyle, T: InsettableShape {
        self.configuration.backgroundView = AnyView(
            shape
                .fill(
                    style,
