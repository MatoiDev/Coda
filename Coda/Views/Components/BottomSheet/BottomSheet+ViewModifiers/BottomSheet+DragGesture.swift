...
public extension CodaUIBottomSheet {
    ...
    func onDragChanged(_ perform: @escaping (DragGesture.Value) -> Void) -> CodaUIBottomSheet {
    ...
    func onDragEnded(_ perform: @escaping (DragGesture.Value) -> Void) -> CodaUIBottomSheet {
