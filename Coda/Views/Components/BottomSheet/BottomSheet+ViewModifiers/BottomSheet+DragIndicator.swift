...
public extension CodaUIBottomSheet {
    ...
    func showDragIndicator(_ bool: Bool = true) -> CodaUIBottomSheet {
    ...
    func dragIndicatorColor(_ color: Color) -> CodaUIBottomSheet {
    ...
    func dragIndicatorAction(_ action: @escaping (GeometryProxy) -> Void) -> CodaUIBottomSheet {
