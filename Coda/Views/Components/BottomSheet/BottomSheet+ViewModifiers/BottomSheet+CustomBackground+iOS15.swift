...
public extension CodaUIBottomSheet {
    ...
    ///   drawn behind it.
    func customBackground(ignoresSafeAreaEdges edges: Edge.Set = .all) -> CodaUIBottomSheet {
    ...
    ) -> CodaUIBottomSheet where S: Shape {
        return self.customBackground(
            .background,
            in: shape,
            fillStyle: fillStyle
    ...
    func customBackground<S>(
        in shape: S,
        fillStyle: FillStyle = FillStyle()
    ) -> CodaUIBottomSheet where S: InsettableShape {
        return self.customBackground(
            .background,
            in: shape,
            fillStyle: fillStyle
